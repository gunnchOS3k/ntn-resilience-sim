...
REQUIRED = [
    "results/e2e/gary_emergency_resilience.md",
    "results/e2e/gary_emergency_metrics.json",
    "results/e2e/ntn_research_card.md",
...
def main():
    ...
    if missing:
        print("FAIL", missing)
        return 1
    print("PASS e2e artifacts ntn-resilience-sim")
    return 0
